...
public class Storage implements IStorage {
    ...
    @Override
    public void put(@NonNull String key, @NonNull Object items) {
        sp.edit().putString(key, gson.toJson(items)).apply();
    }

    @Override
    public void putString(@NonNull String key, @NonNull String str) {
    ...
    @Override
    public void putLong(@NonNull String key, long number) {
    ...
    @Override
    public void putInt(@NonNull String key, int number) {
    ...
    @Override
    public <T> List<T> getCollection(@NonNull String key, @NonNull Type type) {
        return get(key, type);
    }
